...
const file_proto_category_category_proto_rawDesc = "" +
	"\n" +
	"\x1dproto/category/category.proto\x12\bprotorpc\"$\n" +
	...
	"\x06status\x18\x03 \x01(\tR\x06status2T\n" +
	"\bCategory\x12H\n" +
	"\x12GetCategoriesByIDs\x12\x1a.protorpc.GetCatIDsRequest\x1a\x14.protorpc.CatIDsResp\"\x00B\vZ\tcategory/b\x06proto3"
